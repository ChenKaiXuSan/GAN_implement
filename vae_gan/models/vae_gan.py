...
class Encoder(nn.Module):
    def __init__(self, opt):
        ...
        self.x_to_mu = nn.Linear(512, opt.latent_dim)
        self.x_to_logvar = nn.Linear(512, opt.latent_dim)
...
if __name__ == "__main__":
    ...
    imgs = torch.randn(64, 3, opt.img_size, opt.img_size).cuda()
    print(imgs.shape)
    x = encoder(imgs)
