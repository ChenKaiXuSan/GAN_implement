# %% 
"""
wgan with different loss function, used the pure dcgan structure with full attention model.
implement loss function: wgan, wgan-gp, wgan-div, ori gan loss
"""
import os 
import time
import torch
...
# %%
class Trainer_wgan(object):
    def __init__(self, data_loader, config):
        super(Trainer_wgan, self).__init__()
